...
namespace Kanji_Paint_Project
{
    public partial class Form1 : Form
    {
        ...
        public int countWords(string text) // Generated by ChatGPT
        {
        ...
        public void writeJson(string imgLocation, string name, string description, string strokeCount, string wordCount)
        {
